...
public class JtsAdapterFactoryTest {
    ...
    public void shouldHandleMultiLineString() {
        ...
        MultiLineString source = gf.createMultiLineString(new LineString[]{
                ...
                gf.createLineString(new Coordinate[]{new Coordinate(36.7, 53.654321), new Coordinate(33.9, 23.8)})
        });
    ...
    public void shouldHandleMultiPolygonWithSinglePolygonWithoutHoles() {
        ...
        MultiPolygon source = gf.createMultiPolygon(new Polygon[]{
            gf.createPolygon(gf.createLinearRing(new Coordinate[]{new Coordinate(56.7, 83.6), new Coordinate(43.9, 5.8), new Coordinate(43.9, 10), new Coordinate(56.7, 83.6)}))
        });
    ...
    public void shouldHandleMultiPolygonWithPolygonsWithoutHoles() {
        ...
        MultiPolygon source = gf.createMultiPolygon(new Polygon[]{
            gf.createPolygon(gf.createLinearRing(new Coordinate[]{new Coordinate(56.7, 83.6), new Coordinate(43.9, 5.8), new Coordinate(43.9, 10), new Coordinate(56.7, 83.6)})),
            gf.createPolygon(gf.createLinearRing(new Coordinate[]{new Coordinate(66.7, 83.6), new Coordinate(43.9, 5.8), new Coordinate(43.9, 10), new Coordinate(66.7, 83.6)}))
        });
    ...
    public void shouldHandleMultiPolygonWithSinglePolygonWithHoles() {
        ...
        MultiPolygon source = gf.createMultiPolygon(new Polygon[]{
            gf.createPolygon(
                    ...
                    new LinearRing[]{
                            gf.createLinearRing(new Coordinate[]{new Coordinate(46.7, 73.6), new Coordinate(33.9, 5.8), new Coordinate(33.9, 9), new Coordinate(46.7, 73.6)}),
                            gf.createLinearRing(new Coordinate[]{new Coordinate(44.7, 70.6), new Coordinate(33.9, 5.8), new Coordinate(33.9, 9), new Coordinate(44.7, 70.6)})
                    }
            )
        });
